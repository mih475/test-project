...
def main():
    print("=== S1 FROZEN 2025 HOLDOUT ===")
    print("Exact S1 implementation frozen after 2021-2023 development and 2024 validation. No tuning. 2026 remains unseen.")
    print("Frozen holdout gate is unchanged from 2024: n>=100, ES1 avgR>0, ES1 PF>=1.10, drop5 avgR>0, ES4 avgR>0.")
    raw = load_year()
    trades = []
    ...
    t.to_csv("s1_holdout_2025_trades.csv", index=False)
    ...
    costs.to_csv("s1_holdout_2025_costs.csv", index=False)
    print("\nCOST SENSITIVITY")
    ...
    print("\nFROZEN_2025_HOLDOUT_GATE", gate)
    if gate:
        print("INTERPRETATION: S1 survives the untouched 2025 holdout and earns a 2026 recent-regime check. Do not tune before 2026.")
    else:
        print("INTERPRETATION: S1 fails the untouched 2025 holdout. Do not repair/tune using 2025.")
